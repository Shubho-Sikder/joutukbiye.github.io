...
<body>
	...
	<div class="pro">
		<?php 
		$query = "SELECT * FROM $visitortable ORDER BY visited_at DESC";
			...
			if(mysqli_num_rows($result) > 0) {
				while($frow = mysqli_fetch_array($result)) {
					...
					<div class="table-responsive" style="padding-top:30px;">
							<table >
								...
								<td style="padding-left: 30px;"><span><h2><a href="visitingprofile.php?id='.$row["email"].'">'.$row["name"].'</a></h2></span><span style="padding-top: 10px; font-weight:700;">Visited at: '.$frow["visited_at"].'</span></td>
								</tr>
							</table>
						</div>
					';
				...
				echo '<h1 style="text-align: center;">You do not have any visitor yet.</h1>';
			} ?>
	</div>
</body>
</html>